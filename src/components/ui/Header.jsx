          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden lg:flex items-center space-x-4">
              <Button
                ...
                className="bg-white text-white border-2 border-accent hover:bg-white hover:text-accent transition-all duration-300 font-heading-regular tracking-wider uppercase text-heading-base"
