      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-12">
          ...
          <div className="md:col-span-2 text-center md:text-left">
            ...
            <p className="text-gray-300 mb-6 max-w-md mx-auto md:mx-0 font-sans">
            ...
            <ul className="space-y-2 text-gray-300">
              {footerLinks.explore.map((link) => (
                <li key={link.path}>
                  <Link
                    to={link.path}
                    className="hover:text-accent transition-colors duration-300 inline-flex items-center justify-center md:justify-start group font-sans"
                  >
                    <span>{link.name}</span>
                    <Icon 
                      name="ArrowUpRight" 
        ...
        <div className="border-t border-white/10 pt-8 mt-12 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm mb-4 md:mb-0 text-center md:text-left font-sans">
            ...
            <div className="flex space-x-6 text-sm text-gray-300">
              {footerLinks.legal.map((link) => (
                <Link
                  key={link.path}
                  to={link.path}
                  className="hover:text-accent transition-colors duration-300 font-sans"
                >
                  {link.name}
                </Link>
              ))}
